          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <select
                  id="sub"
                  value={this.data.subkategori_id}
                  name="subkategori_id"
                  onChange={this.endreVerdi}
                />
              </td>
            ...
            <tr>
              <td colSpan="2">
                ...
                <button onClick={this.velgMinPosisjon}>
                  Velg min nåverende posisjon
                </button>
                <PositionMap
                  id="pos"
                  width="300px"
