              ...
              <div className='row'>
                  ...
                  <div className='col'>
                      <div className='nedtrekksmeny'>
                          <button onClick='visKommuner' className='dropdown-toggle' data-toggle='dropdown'>Kommune</button>
                          <div id='nedtrekk' className='dropdown-menu'>
                              <input type='text' placeholder='Søk...' id='sokInp' onKeyUp='filtrer' className='dropdown-item'/>
