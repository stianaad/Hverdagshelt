...
module.exports = class HendelseDao extends Dao {
    lagNyHendelse(json, callback){
        var hendelse = [json.overskrift, json.bruker_id, json.beskrivelse, json.sted, json.bilde, json.lengdegrad, json.breddegrad];
        super.query(
    ...
    slettHendelse(json, callback) {
        ...
        super.query(
            'DELETE FROM hendelse WHERE hendelse_id = ?',
            [id],
            callback
        );
    }
